<?php
/*Formulario de contacto HTML5, PHP Y Bootstrap
Creado por: Ing.Guillermo Amaya
Version: 1.1*/
...
if(isset($_POST['enviar'])){
	...
	$para = "eurobetcolombia@gmail.com";//Email al que se enviará
...
//Comprobamos que los datos enviados a la función MAIL de PHP estén bien y si es correcto enviamos
	if(mail($para, $asunto, $mensaje, $headers)){
		...
		echo "<br />";
		echo '<a href="http://www.eurobet.com.co">Volver</a>';
	}else{
