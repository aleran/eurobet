            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-offset-2">
                		<center><h3>Seleccione las fechas para mostrar tickets ganadores por Recargas:</h3><br></center>
	                	 <form class="form-horizontal" method="POST" action="ganadores_pr.php">
