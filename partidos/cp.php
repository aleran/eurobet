<?php
	...
	if ($_POST["dep"]==4) {
		...
		$sql_cp="INSERT INTO partidos
								...
								VALUES('".$_POST["id"]."','".$_POST["compe_selec"]."','".$_POST["equipo1_selec"]."','".$_POST["equipo2_selec"]."','".$_POST["fecha"]."','".$_POST["hora"]."','".$_POST["fecha_v"]."','".$_POST["hora_v"]."','".$_POST["gj1"]."','".$_POST["gj2"]."','".$_POST["v_alta"]."','".$_POST["alta"]."','".$_POST["baja"]."','".$_POST["v_runline1"]."','".$_POST["v_runline2"]."','".$_POST["runline1"]."','".$_POST["runline2"]."')";
		$rs_cp=mysqli_query($mysqli,$sql_cp)or die(mysqli_error($mysqli));
	}
	...
	if ($_POST["dep"]==5) {
		...
		$sql_cp="INSERT INTO partidos
								...
								VALUES('".$_POST["id"]."','".$_POST["compe_selec"]."','".$_POST["equipo1_selec"]."','".$_POST["equipo2_selec"]."','".$_POST["fecha"]."','".$_POST["hora"]."','".$_POST["fecha_v"]."','".$_POST["hora_v"]."','".$_POST["gj1"]."','".$_POST["gj2"]."','".$_POST["v_runline1"]."','".$_POST["v_runline2"]."','".$_POST["runline1"]."','".$_POST["runline2"]."')";
		$rs_cp=mysqli_query($mysqli,$sql_cp)or die(mysqli_error($mysqli));
	}
	...
	echo "<script>alert('Partido creado correctamente');window.location='selec_deporte.php';</script>";
?>