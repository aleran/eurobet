<?php
	...
	if (isset($_POST["cedula"])) {
		...
		if ($num_ci == 1) {
			echo "<script>alert('Cedula ya registrada anteriormente');window.location='index.php';</script>";
		}
		...
		if ($num_correo == 1) {
			echo "<script>alert('Correo ya registrado anteriormente');window.location='index.php';</script>";
		}
