...
<?php
	...
	echo "- En caso de un error en la linea, rotación, hora programada, máxima apuesta, apuestas fuera de tiempo o comenzando el evento, las apuestas serán CANCELADAS y el monto del arriesgado será devuelto en consecuencia.<br>";
	echo "<p>Conozco y acepto las reglas.<br>";
	echo "<p>visita www.eurobet.com.co<br>";
