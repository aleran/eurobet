                ...
                <div class="row">
	                ...
	                <?php
	                	...
	                	if ($_SESSION["tipo"]=="root") {
	                		$sql_act="SELECT * FROM tickets_c WHERE activo='1' AND ganar='0' AND (fecha BETWEEN '".$desde."' AND '".$hasta."')";
	                	}
	                	else {
	                		$sql_act="SELECT * FROM tickets_c WHERE activo='1' AND ganar='0' AND agencia='".$_SESSION["agencia"]."'AND (fecha BETWEEN '".$desde."' AND '".$hasta."')";
	                	}
