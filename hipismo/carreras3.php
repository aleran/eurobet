        ...
        <br>
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <br><center><h3>Multiples</h3></center>

                        <?php
                            if (isset($_SESSION["pais"])) {
                                echo '<form name="form" id="form" action="carrera_selec3.php" method="POST">';
                            }
                            else {
                                echo '<form name="form" id="form" action="carrera_selec3.php?pais='.$_GET["pais"].'" method="POST">';
                            }
