        ...
        <br>
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <br><center><h3>Mixtas</h3></center>

                        <?php
                            if (isset($_SESSION["pais"])) {
                                echo '<form name="form" id="form" action="carrera_selec2.php" method="POST">';
                            }
                            else {
                                echo '<form name="form" id="form" action="carrera_selec2.php?pais='.$_GET["pais"].'" method="POST">';
                            }
