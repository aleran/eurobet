                ...
                if ($_SESSION["tipo"]=="root" || $_SESSION["tipo"]=="admin" ) {
                 echo '<li>
                    ...
                    if ($_SESSION["tipo"]=="root") {
                        ...
                        echo '<li>
                        <a href="#" title="Evaluacion de Partidos"><span class="icon-checkmark2"></span>&nbsp;Evaluar Carreras</a>
                        </li>';
                    ...
                    echo '<li>
                        <a href="carreras.php" title="Apuestas"><span class="icon-coin-dollar"></span>&nbsp;Apostar</a>
                    </li>';

                    
                    echo '<li>
                        <a href="consultas_c.php" title="Consulta de Tickets Activos"><span class="icon-file-text2"></span>&nbsp;Tickets</a>
                    </li>';
                    if ($_SESSION["tipo"]=="root" || $_SESSION["tipo"]=="admin" ) {
                    echo '<li>
                                <a href="saldos_c.php" title="Resumen Económico detallado de Agencias"><span class="icon-coin-dollar"></span>&nbsp;Cuentas</a>
                            </li>';
                    }
                    echo '<li>
